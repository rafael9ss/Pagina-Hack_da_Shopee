      ...
      <section className="relative bg-black text-white py-20 md:py-32 overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <img src="/headline-vendas.jpg" alt="Dashboard Shopee com vendas de +1.000 pedidos" className="w-full max-w-2xl mx-auto rounded-lg shadow-2xl mb-8 md:mb-10" />
        ...
        <div className="container">
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <ScrollReveal delay={0}>
              ...
              <a href="https://lastlink.com/p/C5A7176F8/checkout-payment/" target="_blank" rel="noopener noreferrer" className="block w-full">
                <Button className="w-full bg-gray-700 hover:bg-gray-600 text-white py-4 sm:py-5 md:py-6 text-sm sm:text-base md:text-lg font-bold break-words">
                  QUERO O BÁSICO
                </Button>
              </a>
            </Card>
