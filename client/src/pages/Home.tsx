...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <WhatsAppButton />
      {/* Hero Section */}
      <section className="relative bg-black text-white py-0.5 md:py-8 overflow-hidden">
            ...
            */}
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<vturb-smartplayer id="vid-692dc6f83dbab420e98ff2ad" style="display: block; margin: 0 auto; width: 100%; max-width: 200px; aspect-ratio: 16/9; background: #000;"></vturb-smartplayer>',
              }}
              className="w-full flex justify-center"
            />
            <button 
              onClick={scrollToPlans}
              className="premium-cta-btn text-[10px] sm:text-base md:text-lg lg:text-xl px-3 sm:px-10 md:px-12 lg:px-14 py-2 sm:py-6 md:py-7 lg:py-8 inline-block max-w-[75%] break-words mt-0 md:mt-3 hover:shadow-lg active:shadow-md"
            >
              QUERO MEU ACESSO
            </button>
