...
export default function Home() {
  ...
  useEffect(() => {
    ...
    script.src =
      'https://scripts.converteai.net/a930954b-410c-46a3-9750-318da063a52e/players/6978ef4614d220c3d64fd2b3/v4/player.js';
    script.async = true;
            ...
            */}
            <div
              dangerouslySetInnerHTML={{
                __html:
                  '<vturb-smartplayer id="vid-6978ef4614d220c3d64fd2b3" style="display: block; margin: 0 auto; width: 100%; max-width: 500px;"></vturb-smartplayer>',
              }}
              className="w-full flex justify-center"
            />
            <button 
              onClick={scrollToPlans}
              className="premium-cta-btn premium-glow-intense subtle-bounce text-sm sm:text-base md:text-lg lg:text-xl px-6 sm:px-10 md:px-12 lg:px-14 py-4 sm:py-6 md:py-7 lg:py-8 inline-block max-w-[90%] break-words mt-2 md:mt-6 hover:shadow-lg active:shadow-md"
            >
              QUERO MEU ACESSO
            </button>
